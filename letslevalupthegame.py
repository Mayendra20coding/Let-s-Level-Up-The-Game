...
font_size = 72
pygame.init()
background_image = pygame.transform.scale(pygame.image.load("blue_abstract_background_310971.jpg"), (screen_width, screen_height))
font=pygame.font.SysFont("Arial", font_size)
class Sprite(pygame.sprite.Sprite):
    def __init_(self,color,height,width):
        super()._init_()
        self.image=pygame.Surface([width,height])
        self.image.fill(
             pygame.Color('dodgerblue'))
        pygame.draw.rect(self.iamge,color,pygame.Rect(0,0,width,height))
